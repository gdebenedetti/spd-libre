...
var apiProxy = require('./lib/fullNodeProxy.js').createProxyServer( { target: 'https://api.hcdn.gob.ar:9000/apirest' } );
var appProxy = require('./lib/fullNodeProxy.js').createProxyServer( { target: 'http://sparl.hcdn.gob.ar' } );
var oauthProxy = require('./lib/fullNodeProxy.js').createProxyServer( { target: 'https://oauth2.hcdn.gob.ar:9000/o' } );
